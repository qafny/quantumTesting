...
def get_tree():
    new_tree = visitor.startVisit(qc, circuitName="Qiskit Circuit H gate", optimiseCircuit=False, showDecomposedCircuit=True)
    return new_tree
...
def simulate_circuit(num_qubits, state_bits):
